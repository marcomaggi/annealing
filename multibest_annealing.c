...
static int
find_best_configuration_position (gsl_annealing_multibest_workspace_t * S)
{
  int	position;
...
static void
insert_new_at_best_configurations_position (gsl_annealing_multibest_workspace_t * S,
					    int position)
{
  int	last;
...
void 
gsl_annealing_multibest_solve (gsl_annealing_multibest_workspace_t * S)
{
