...
static double
compute_fraction (gsl_annealing_manytries_workspace_t * S, double energy)
{
...
void 
gsl_annealing_manytries_solve (gsl_annealing_manytries_workspace_t * S)
{
  double	x;
  size_t	selected_new;
